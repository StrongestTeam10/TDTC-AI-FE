...
export default function RichTextEditor({ value, onChange }: RichTextEditorProps) {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'min-h-[240px] rounded-b border border-t-0 border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-600 prose prose-invert prose-sm max-w-none',
      },
    },
  });
