            ...
            <div className="w-full xl:w-[350px] space-y-4 shrink-0">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-slate-700 bg-slate-900 overflow-hidden">
                  <button 
                    className="w-full px-4 py-3 text-left font-medium text-slate-200 bg-slate-800 hover:bg-slate-700 flex justify-between items-center"
                ...
                <div className="rounded-lg border border-slate-700 bg-slate-900 overflow-hidden">
                  ...
                  {activeStep === 'after' && (
                    <div className="p-4 border-t border-slate-700 h-[600px] overflow-y-auto custom-scrollbar">
                      <ScenarioForm
              ...
              <div className="flex flex-col md:flex-row gap-4 h-[450px]">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                  ...
                  <div className="flex-1 relative rounded-lg border border-slate-700 overflow-hidden bg-slate-900">
                    ...
                    />
                    {!predictResult && (
                      <div className="absolute inset-0 bg-slate-900/50 flex items-center justify-center text-sm text-slate-400 z-10 backdrop-blur-[2px]">
                        예측을 실행해주세요
                      </div>
                    )}
                  </div>
